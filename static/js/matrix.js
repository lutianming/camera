var sm;
function show_matrix(id, data, columns){
    sm = new ScatterMatrix(id, data, columns);
    sm.render();
}

ScatterMatrix = function(container, data, columns) {
    this.__data = data;
...
ScatterMatrix.prototype.render = function () {
    ...
    var container = d3.select(self.__container).append('div')
